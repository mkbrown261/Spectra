...
/* ══════════════════════════════════════════════════════════════════
   TOOL SHELL
══════════════════════════════════════════════════════════════════ */
function toolShell(name: string, _id: string): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    :root{--bg:#060810;--ice:#E8F4FD;--accent:#7BB8D4;--glow:#A8D8F0;--border:rgba(168,216,240,0.12)}
    ...
    .nav-logo{font-family:'Space Mono',monospace;font-size:0.9rem;letter-spacing:0.3em;color:var(--glow);text-decoration:none}
    .nav-back{color:var(--accent);text-decoration:none;font-size:0.78rem;letter-spacing:0.1em;opacity:0.55;transition:opacity 0.2s}
    ...
    .status-badge{font-family:'Space Mono',monospace;font-size:0.60rem;letter-spacing:0.3em;color:var(--accent);text-transform:uppercase;margin-bottom:2.5rem;opacity:0.55;display:inline-flex;align-items:center;gap:0.5rem}
    .status-dot{width:5px;height:5px;border-radius:50%;background:var(--glow);animation:blink 2s ease-in-out infinite}
    ...
    .pulse-ring{width:72px;height:72px;border-radius:50%;border:1px solid rgba(168,216,240,0.3);margin:0 auto 3rem;animation:pulse 2.4s ease-in-out infinite}
...
<head>
  ...
  <meta name="description" content="Spectra is an AI-powered creative suite. Five systems. One platform. Infinite creative output.">
  <link rel="icon" type="image/svg+xml" href="/favicon.svg">
  <link rel="preconnect" href="https://fonts.googleapis.com">
...
<nav id="nav">
  ...
  <ul class="nav-links" role="list">
    ...
    <li><a href="#scene-about"    class="nav-link">About</a></li>
